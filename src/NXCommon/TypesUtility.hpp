...
inline constexpr StringLiteral DataTypeToString(DataType dataType)
{
  ...
  default:
    throw std::runtime_error("NX::DataTypeToString: Unknown DataType");
  }
}
...
{
  static const std::vector<std::string> dataTypes = {DataTypeToString(NX::DataType::int8),    DataTypeToString(NX::DataType::uint8),  DataTypeToString(NX::DataType::int16),
                                                     DataTypeToString(NX::DataType::uint16),  DataTypeToString(NX::DataType::int32),  DataTypeToString(NX::DataType::uint32),
                                                     DataTypeToString(NX::DataType::int64),   DataTypeToString(NX::DataType::uint64), DataTypeToString(NX::DataType::float32),
                                                     DataTypeToString(NX::DataType::float64), DataTypeToString(NX::DataType::boolean)};
  return dataTypes;
}
